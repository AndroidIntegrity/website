...
const headerData: headerData[] = [
    {
        title: 'Our Team',
        description: 'We are a small collective of people passionate about customizing our Android devices and using them to their full extent.'
    },
    {
        title: 'Our Mission',
        description: 'Our goal is to rework the Play Integrity system to be inclusive of rooted devices, while maintaining and supporting security.'
    },
    {
        title: 'Our Vision',
        description: 'We aim to be a trusted third party to vet custom ROMs, in order to assist Google in being inclusive, yet secure.'
    },
    {
        title: 'Get Involved',
        description: 'Join us in our mission to promote a fair and open Android operating system. Sign our petition and follow us on social media.'
    }
]
