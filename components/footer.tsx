...
const Footer = () => {
  return (
    <footer className="mt-8 py-4 px-2 sm:px-4 md:px-8 lg:px-16 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 bottom-0 bg-background text-foreground w-full p-4">
